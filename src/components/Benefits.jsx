  ...
  const benefits = [
    {
      number: '01',
      title: '追いたい仲間ができる',
      description: '「この人の次の一手が気になる」そう思える仲間と出会えます。お互いの挑戦を見守り、応援し合う関係。それがあなた自身のIPを育てる土壌になります。',
    ...
    },
    {
      number: '03',
      title: '実践と発信の場がある',
      description: 'ただ学ぶだけでなく、学んだことを発信する機会を提供。LT大会や勉強会での登壇経験が、あなたのIPとして積み上がっていきます。',
