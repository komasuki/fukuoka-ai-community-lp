...
function Channels() {
  ...
  useEffect(() => {
    ...
    const items = sectionRef.current?.querySelectorAll('.channel-card')
  ...
  const channels = [
    {
      ...
      name: 'Discord',
      description: 'メインの交流場所。日々の学びや挑戦を共有。あなたの活動がメンバーの目に触れる場。',
      action: '準備中',
      actionLink: '#join',
      color: '#5865F2'
    },
    ...
    },
    {
      ...
      name: 'Instagram',
      description: 'AI作品やイベントの様子を投稿。あなたの作品がコミュニティの名前とともに広がります。',
      action: '準備中',
      actionLink: '#join',
      color: '#E4405F'
    },
    {
      ...
      name: 'X (Twitter)',
      description: 'メンバー同士の相互フォロー、リポストで発信力を相互に高め合う。#FukuokaAI で文脈を作る。',
      action: '準備中',
      actionLink: '#join',
      color: '#000000'
    },
    ...
    },
    {
      ...
      name: 'LINE公式',
      description: 'イベントのリマインドや重要なお知らせ。見逃し防止で、継続参加をサポート。',
      action: '準備中',
      actionLink: '#join',
      color: '#06C755'
    }
  ...
  const newsletter = {
    title: 'メールマガジン',
    description: 'AIの最新トレンドやイベント情報を週1回お届け。じっくり読みたい方に。'
  }
          ...
          {channels.map((channel, index) => (
            ...
            >
              ...
              <div className="channel-content">
                ...
                <a href={channel.actionLink} className="channel-action">
                  {channel.action}
                </a>
              </div>
            </div>
